...
<center><h1 class="heading">District Master Entry form</h1></center>
    
    <form action="Dist_Action.php" method = "post">
        <!-- <label for="dist_name"> Enter District </label><br>
    ...
    //  $query = "SELECT * FROM 'Dist_Master' order by Dist_Name";
    ...
    ?>  
        ...
        <td align="center"><?php echo $i;?></td>
            ...
            <td align="center"><a href="<?php echo $rows['Dist_Code']?>"> edit </a></td>
        </tr>
    <?php
    $i++;
    }
